...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create tradian-a864
  fly apps create tradian-a864-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app tradian-a864
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app tradian-a864-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'tradian-a864-staging' does not match app name in config file 'tradian-a864'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name tradian-a864-db
  fly postgres attach --app tradian-a864 tradian-a864-db

  fly postgres create --name tradian-a864-staging-db
  fly postgres attach --app tradian-a864-staging tradian-a864-staging-db
  ```
